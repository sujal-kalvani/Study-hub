  ...
  return (
    <div className='h-screen mt-20 flex flex-col justify-center items-center gap-8'>
      ...
      <div className='w-[50%] flex justify-between'>
        ...
        <div className='relative border border-gray-300 w-[35%] h-14 flex pl-12 rounded-sm'>
          ...
          <button className='bg-blue-600 text-white w-[30%] cursor-pointer rounded-r-sm'>Search</button>
